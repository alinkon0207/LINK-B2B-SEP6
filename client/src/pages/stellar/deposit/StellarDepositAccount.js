    ...
    <>
      ...
      <div className="max-w-[80%] md:max-w-[70%] mx-auto mb-10 sm:px-12 ">
        <div className="flex items-center justify-between mb-5">
          ...
          <h1 className="text-primary text-xl font-semibold">Send NGN</h1>
          <div
        ...
        <div className="space-y-6">
          <p className="text-black text-base">
            Send the exact NGN to the account below{' '}
          </p>
          ...
          <div className="space-y-5 pt-5">
            ...
            <div className="flex items-center space-x-4">
              <BsInfoCircle className="text-primary text-3xl lg:text-xl font-medium" />
              <p className="text-primary text-sm font-medium">
                Please do not add any crypto phrase or your transfer will not be
                be processed.
              </p>
            </div>
          </div>
